...
import com.qishiyi.oa.base.BaseAction;
...
//		getValueStack().set("list", list);
		...
		HQLHelper hh = new HQLHelper(Template.class);//在构造方法中拼接FROM 语句
		PageBean pb = templateService.getPageBean(hh,currentPage);
	...
	public String download(){
		...
		String agent = ServletActionContext.getRequest().getHeader("user-agent"); //获取客户端是什么浏览器
		try {
